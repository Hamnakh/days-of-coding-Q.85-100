...
var favoriteFruits = ["mango", "cherry", "strawberry"];
...
var names = ["hamna", "minhaj", "aijaz", "fiza"];
...
var words = ["hellow", "world", "typescript", "javascript"];
...
function daysUntilNewYear() {
    ...
    var defferenceInMillis = nextYear.getTime() - currentDate.getTime();
    var daysLeft = Math.ceil(defferenceInMillis / (1000 * 60 * 60 * 24));
    return daysLeft;
}
...
var nextBirthday = getNextBirthday(24, 10);
